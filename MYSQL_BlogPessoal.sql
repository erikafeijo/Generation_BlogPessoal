...
CREATE TABLE IF NOT EXISTS `BlogPessoal`.`tb_usuarios` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `nome VARCHAR` VARCHAR(255) NOT NULL,
  `usuario VARCHAR` VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `BlogPessoal`.`tb_postagens` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `titulo VARCHAR` VARCHAR(100) NOT NULL,
  `texto VARCHAR` VARCHAR(100) NOT NULL,
  `data DATE` DATE NULL,
